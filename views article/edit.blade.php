...
@section('sub_title' , 'edit_Article')
    ...
    <form>
      <div class="card-body">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <select class="form-control select2" id="category_id"  name="category_id" style="width: 100%;">
                  ...
                  <option selected>{{ $articles->category->name }}</option>
        ...
        <div class="form-group">
          ...
          value="{{ $articles->title }}"  name="title" placeholder="Enter Article title">
        </div>
        <div class="form-group">
            <label for="short_description">Short Description</label>
            <input type="text" class="form-control" id="short_description"
            value="{{ $articles->short_description }}"  name="short_description" placeholder="Enter Article title">
          </div>
          <div class="form-group">
            <label for="full_description">Full Description</label>
            <input type="text" class="form-control" id="full_description"
            value="{{ $articles->full_description }}"  name="full_description" placeholder="Enter Article title">
          </div>
          <div class="row">
